...
function Tools(props) {
    ...
    return (
        <div id='tools-div'>
            <div className='mob-tools-below-480'>
                {
                    toggle ? (
                        <>
                            <div style={{ backgroundColor: 'red' }} onClick={() => setToggle(!toggle)}>
                                <span onClick={() => setToggle(!toggle)}><GoChevronDown size='1.6em' /></span>
                                <span style={{ fontSize: '30px', fontWeight: '700' }}>TECHNOLOGIES</span>
                            </div>
                            <div id='mob-tools-links'>
                        ...
                        <>
                            <div onClick={() => setToggle(!toggle)}>
                                <span style={{ fontWeight: '700' }}><GoChevronRight size="1.6em" /></span><span style={{ fontSize: '30px', fontWeight: '700' }}>TECHNOLOGIES</span>
                            </div>
                        </>
                    )}
            </div>

            <div className='tools-above-480'>
