...
function Tools(props) {
    ...
    return (
        <div id='tools-div'>
            <div className='mob-tools-below-360'>
                {
                    toggle ? (
                        <>
                        ...
                        <>
                            <div>
                                <span onClick={() => setToggle(!toggle)} style={{ fontWeight: '700' }}><GoChevronRight size="1.6em" /></span><span style={{ fontSize: '30px', fontWeight: '700' }}>TECHNOLOGIES</span>
                            </div>
                        </>
                    )}
            </div>
