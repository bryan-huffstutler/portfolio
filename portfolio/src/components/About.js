                ...
                {toggle ?
                    ...
                    <>
                        <div onClick={() => setToggle(!toggle)}>
                            <span style={{ fontWeight: '700' }}><GoChevronRight size="1.6em" /></span><span style={{ fontSize: '30px', fontWeight: '700' }}>ABOUT ME</span>
                        </div>
                    </>
                }
            </div>
